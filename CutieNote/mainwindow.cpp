    ...
    , ui(new Ui::MainWindow)
{
    ...
    setWindowTitle("Untitled - Cutie Note ");
...
{
    QSettings setting("Lock", "Cutie Note");
...
void MainWindow::on_textEdit_textChanged()
{
    ...
    if (fileText != ui->textEdit->toPlainText())
    {
        if (isFresh == false)
        {
            setWindowTitle("*" + currentFile + " - Cutie Note");
        }
        else
        {
            setWindowTitle("*Untitled - Cutie Note");
    ...
    else
    {
        if (isFresh == false)
        {
            this->setWindowTitle(currentFile + " - Cutie Note");
        }
        else
        {
            this->setWindowTitle("Untitled - Cutie Note");
        }
    }
...
void MainWindow::on_action_New_triggered()
{
    ...
    else
    {
        currentFile.clear();
        ui->textEdit->setText(QString());
        this->setWindowTitle("Untitled - Cutie Note Qt");
        isFresh = true;
        fileText = ui->textEdit->toPlainText();
    }
}
...
void MainWindow::on_action_Open_triggered()
{
    ...
    if (!file.open(QIODevice::ReadOnly | QFile::Text))
    {
        ...
        errorMessage.setText("Cutie Notes couldnt open this file.");
    ...
    ui->textEdit->document()->toPlainText();
    setWindowTitle(QFileInfo(file.fileName()).fileName() + " - Cutie Note");
...
void MainWindow::on_action_Save_triggered()
{
    ...
    if (!file.open(QIODevice::WriteOnly | QFile::Text))
    {
        ...
        errorMessage.setWindowTitle("Error");
        errorMessage.setIcon(QMessageBox::Warning);
        errorMessage.setText("Cutie Note couldnt save changes.");
...
{
    QString link = "https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox";
    QDesktopServices::openUrl(QUrl(link));
}
